...
export const zhTW: LocaleMessages = {
  ...
  home: {
    ...
    product: {
      ...
      capabilities: [
        {
          title: "一鍵部署",
          copy: "選擇、設定、部署。託管與持久化由協議處理——你無需觸碰任何基礎設施。",
        },
        {
          title: "金鑰不可見",
          copy: "金鑰由身分注入，隱於協議之下，並具備按帳戶熔斷、互不級聯的保護。",
        },
        {
          title: "每次推理均可計量",
          copy: "每一次推理按次記錄，消耗直連結算。透明、可稽核，絕不靜默。",
        },
      ],
    },
    ecosystem: {
      ...
      scenarios: [
        {
          ...
          copy: "CorrAI 運行於 De(cision)Agent 框架，受共識、身分與連續性約束。它呼叫 DeAgentAI 專有模型生成策略判斷，結晶為自主、持續運行的策略智慧體——首次讓鏈上判斷具備可驗證的策略連續性。",
        },
        {
          title: "AliceAI —— 賽事預測智慧體",
          copy: "AliceAI 的賽事預測直接運行在 DeAgentAI 專有模型之上：模型輸出賽事判斷，AliceAI 將其結晶為可自主決策並在經濟層結算的智慧體。它與 CorrAI 共享同一底層棧——同一智慧，流向不同場景。",
        },
      ],
      agentCards: {
  ...
  agents: {
    ...
    sentry: {
      ...
      strategies: [
        {
          title: "資金費率套利",
          description: "資金費率遠離基準，雙向均可",
          count: "47",
        },
        {
          title: "低換手",
          description: "持倉遠高於成交量，換手偏低",
          count: "52",
        },
    ...
    dailyPush: {
      badge: "即將推出",
      title: "每日推送",
      copy: "匹配結果每天在固定時間送達——無需開啟平台。當市場無可匹配時，我們仍會發送：不捏造訊號，也不沉默。",
      features: [
    ...
    deploy: {
      ...
      steps: [
        {
          title: "連接錢包",
          text: "簽名即登入。無需信箱，無需密碼。身分由內部 UID 承載，後續多個錢包可共享額度與記憶。",
        },
        {
          title: "選擇智慧體並設定條件",
          text: "四種預設策略開箱即用，閾值可調。條件即約束：智慧體只能在你劃定的邊界內工作。",
        },
        {
          title: "點擊部署",
          text: "智慧體按每日計畫運行，結果推送到應用內或 Telegram。用量與餘額可在控制台按次稽核。",
        },
      ],
      codeSample: {
        filename: "agent.py",
  ...
  alphax: {
    hero: {
      ...
      copyMid: "，受共識、身分與連續性約束。它由專有模型生成預測訊號，並以 ",
      copyStrong2: "完全自主交易智慧體",
      copyAfter: " 的形態行動——從決策輔助工具演進為獨立運行的交易智慧。",
      tagsAria: "AlphaX 產品屬性",
      tags: ["回饋訓練", "自主運行", "De(cision)Agent 框架", "鏈上可稽核"],
    },
    does: {
      title: "AlphaX 能做什麼",
      ...
      capabilities: [
        {
          title: "專有模型訊號",
          copy: "基於回饋訓練的專有模型生成預測訊號，並經使用者回饋持續校準，在動態市場中保持可靠與適應力。",
        },
        {
          title: "完全自主交易",
          copy: "不止於決策支援——AlphaX 監控市場、即時調整策略，並以加密市場所需的速度與精度獨立執行。",
        },
        {
          title: "鏈上可稽核業績",
          copy: "作為 De(cision)Agent 框架上的智慧體，其決策遵循身分與連續性原則，結果可在鏈上稽核與驗證。",
        },
      ],
    },
    gallery: {
  ...
  tokenHub: {
    ...
    usage: {
      eyebrow: "用量数据",
      title: "用量透明，每次調用可審計。",
      copy: "按 token 计費，用量按小时汇总。僅存儲 token 计数與延迟，永不保存請求或響應内容。",
      recentCalls: {
        title: "最近調用",
        updated: "每小时更新",
        rows: [
    ...
    integration: {
      ...
      steps: [
        {
          title: "連接钱包，鑄造 Key",
          copy: "使用钱包簽名即可鑄造 Key，無需郵箱注册。Key 綁定地址，可隨时轮換或撤銷。",
        },
        {
          title: "將 base_url 指向 Hub",
          copy: "完全兼容 OpenAI SDK，現有代码無需改动。支持 Python、TypeScript、Go 與 cURL。",
        },
        {
          title: "使用 $AIA 或 $USDT 充值",
          copyBefore: "使用 $AIA 充值可享 ",
          copyStrong: "15% 折扣",
          copyAfter: "。余額與用量在控制台实时可見，并支持消費告警。",
        },
      ],
      codeLines: [
    ...
    ecosystem: {
      ...
      diagram: {
        ...
        callers: [
          { title: "企業客戶", copy: "8 · 生產環境運行中" },
          { title: "DeAgentAI 智能体", copy: "Sentry 及全部内部智能体" },
          { title: "個人開發者", copy: "即将開放", badge: "NEW" },
        ],
        models: [
          "Claude Opus 5",
          "GPT-5.2",
    ...
    waitlist: {
      ...
      invalid: "請輸入有效郵箱",
      rateLimited: "尝試次数過多，請稍後再試",
      unavailable: "候補名單暫时不可用",
      error: "提交失敗，請稍後重試",
    },
  },
  ...
  solutions: {
    hero: {
      ...
      copySep2: "，並經 ",
      copyStrong3: "共識校驗",
      copyAfter: "——你呼叫的不是原始推理，而是可追溯、可複現的判斷單元。",
      ctaContact: "聯繫整合",
      ctaLearn: "了解更多",
    },
    how: {
      ...
      guarantees: [
        {
          step: "01 · 模型",
          title: "自研模型",
          copy: "經回饋循環訓練的專有模型輸出結構化判斷與置信度。相同輸入可複現，而非黑盒機率輸出。",
        },
        {
          step: "02 · 智慧體",
          title: "框架封裝",
          copy: "De(cision)Agent 框架綁定身分、記錄狀態並施加共識校驗，將判斷封裝為有狀態實例。",
        },
        {
          step: "03 · 結算",
          title: "經濟結算",
          copy: "判斷輸出直連經濟層結算，可計量、鏈上可驗證。判斷與價值之間無斷層。",
        },
      ],
    },
    capabilities: {
      ...
      items: [
        {
          title: "結構化判斷",
          copy: "輸出為結構化判斷 + 置信度 + 依據。在共識下經回饋持續校準，相同輸入可複現，而非隨機漂移。",
        },
        {
          title: "有狀態智慧體實例",
          copy: "每次呼叫綁定唯一身分與鏈上記憶，使判斷具備狀態與連續性。在範圍內自主，全程可追溯。",
        },
        {
          title: "經濟結算 API",
          copy: "判斷直接連接經濟層結算，產出可計量、鏈上可驗證的結果。判斷與價值之間無斷層。",
        },
      ],
    },
    useCases: {
      ...
      items: [
        {
          number: "01",
          title: "預測與訊號",
          copy: "賽事、市場與事件預測：一次呼叫獲得結構化判斷，將判斷與產品解耦。",
        },
        {
          number: "02",
          title: "策略與執行智慧體",
          copy: "基於判斷自主執行策略，鏈上可稽核，並可在經濟層結算。",
        },
        {
          number: "03",
          title: "鏈上治理",
          copy: "為 DAO 與協議提供中立、可追溯的判斷源，支撐提案分析與自動化執行。",
        },
        {
          number: "04",
          title: "垂直決策系統",
          copy: "注入領域脈絡，獲得可結算判斷輸出，並快速接入現有系統。",
        },
      ],
    },
    integration: {
  ...
  caseStudies: {
    hero: {
      ...
      feature: {
        ...
        copy: "世界盃期間，AliceAI 透過一組 API 接入 DeAgentAI 專有模型判斷，並上線賽事預測智慧體。零自研模型，直接在經濟層結算。",
        meta: [
    ...
    results: {
      title: "成果",
      intro: "以下數字以真實日誌為準——發布前請核實；未確認項請留空，勿估算。",
      items: [
        { number: "2,000+", label: "賽事預測訊號", sublabel: "世界盃期間" },
        { number: "100K+", label: "累計模型呼叫", sublabel: "" },
    ...
    video: {
      ...
      playAria: "播放合作影片",
      heading: "合作影片",
      caption: "DeAgentAI × AliceAI 聯合訪談 / 案例片",
    },
  },
  ...
  community: {
    hero: {
      ...
      titleAccent: "社群",
      copy: "由開發者、使用者與建設者組成的社群，線上線下共同推動去中心化 AI 智慧體的採用。",
    ...
    snapshots: {
      title: "社群瞬間",
      photoAlt: "DeAgentAI 社群活動",
    },
    conversation: {
      title: "加入全球對話",
      copy: "DeAgentAI 社群遍布全球。與建設者、開發者和使用者即時交流。",
      channels: [
    ...
    ambassador: {
      ...
      copy: "成為 DeAgentAI 生態的催化劑。加入倡導者社群，推動去中心化 AI 採用——在認知、教育與觸達中發揮關鍵作用。",
      cta: "即將推出",
    },
    blogs: {
  ...
  buyback: {
    ...
    burnProgress: {
      ...
      note: "每 3 個月在鏈上銷毀一部分——交易雜湊見下方銷毀歷史，於每次季度銷毀事件後更新。",
    },
    burnHistory: {
      title: "銷毀歷史",
    ...
    mechanism: {
      ...
      steps: [
        ...
        {
          title: "永久銷毀",
          copy: "回購所得 AIA 存放於已揭露託管，並按公布的銷毀計畫銷毀",
        },
      ],
    },
    priceTrend: {
