...
vec3 rainbow(float t){
 vec3 full=.52+.48*cos(6.28318*(t+vec3(0.,.33,.67)));
 float wave=.5+.5*cos(6.28318*t);
 vec3 cool=mix(vec3(.02,.72,.78),vec3(.68,.84,1.),wave);
 cool=mix(cool,vec3(.56,.48,.88),pow(1.-wave,3.)*.28);
 return mix(cool,full,.1);
}
