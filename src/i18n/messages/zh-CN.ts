  ...
  tokenHub: {
    ...
    capabilities: {
      ...
      items: [
        {
          title: "一个 API，多种模型",
          copy: "Claude、GPT、Gemini、DeepSeek 等，统一于兼容 OpenAI 的协议。改一个字符串即可切换模型。",
        },
        {
          title: "按次计量",
          copy: "实时按次计量、定价与结算。请求体永不持久化，仅保留 token 计数与延迟，兼顾可审计与隐私。",
        },
        {
          title: "$AIA 结算",
          copy: "可用 $AIA 或 USDT 结算。使用 $AIA 充值可享折扣，这是原生协议层结算激励。",
        },
      ],
    },
    cta: {
      eyebrow: "开始使用",
      title: "60 秒完成集成",
      copy: "连接钱包，改一个 base_url，即可调用全部前沿模型。免费额度：每月 100 万 tokens。",
      button: "进入产品",
    },
  },
