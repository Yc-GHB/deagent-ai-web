...
export const zhTW: LocaleMessages = {
  ...
  tokenHub: {
    ...
    capabilities: {
      ...
      items: [
        {
          title: "一個 API，多種模型",
          copy: "Claude、GPT、Gemini、DeepSeek 等，統一於相容 OpenAI 的協議。改一個字串即可切換模型。",
        },
        {
          title: "按次計量",
          copy: "即時按次計量、定價與結算。請求體永不持久化，僅保留 token 計數與延遲，兼顧可稽核與隱私。",
        },
        {
          title: "$AIA 結算",
          copy: "可用 $AIA 或 USDT 結算。使用 $AIA 儲值可享折扣，這是原生協議層結算激勵。",
        },
      ],
    },
    cta: {
      eyebrow: "開始使用",
      title: "60 秒完成整合",
      copy: "連接錢包，改一個 base_url，即可呼叫全部前沿模型。免費額度：每月 100 萬 tokens。",
      button: "進入產品",
    },
  },
  ...
  caseStudies: {
    ...
    path: {
      ...
      noteBefore: "同一路徑可被任何需要可驗證判斷與可結算結果的系統複用。",
