...
export const en = {
  ...
  tokenHub: {
    hero: {
      ...
      copyAfter:
        " Request bodies are never persisted, only token counts and latency are kept.",
    ...
    role: {
      ...
      copyAfter:
        " The protocol revenue it generates is one source of $AIA buybacks.",
      flowAria: "AI Token Hub revenue flow",
      flow: [
        {
          title: "Real AI Usage",
          copy: "Industry-wide calls metered per request",
        },
      ...
      items: [
        {
          ...
          copy: "Claude, GPT, Gemini, DeepSeek and more, unified under an OpenAI-compatible protocol. Switch models by changing one string.",
        },
        {
          title: "Per-call Metering",
          copy: "Real-time metering, pricing, and settlement per call. Request bodies are never persisted, only token counts and latency, balancing auditability and privacy.",
        },
        {
          title: "$AIA Settlement",
          copy: "Settle in $AIA or USDT. Top up with $AIA for a discount, a native protocol-level settlement incentive.",
        },
      ],
    },
    cta: {
      ...
      copy: "Connect a wallet, change one base_url, and call every frontier model. Free tier: 1M tokens per month.",
