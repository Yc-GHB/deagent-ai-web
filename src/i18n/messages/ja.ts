...
export const ja: LocaleMessages = {
  ...
  tokenHub: {
    hero: {
      title: '1つの API、すべての最先端モデル',
      copyBefore:
        'AI Token Hub は主要なクローズド／オープンソースモデルを、OpenAI 互換の単一 API の背後に統合します。すべてのコールはリクエスト単位で計量・価格設定・決済され、',
      copyStrong: '$AIA または USDT で支払い可能。',
      copyAfter:
        ' リクエスト本文は永続化されず、トークン数とレイテンシのみ保持します。',
      ctaEnter: 'AI Token Hub に入る',
      ctaIntegration: '連携を見る',
    },
    role: {
      eyebrow: 'IN THE DEAGENTAI STACK',
      title: 'エコシステムでの役割',
      copyBefore:
        'AI Token Hub は DeAgentAI エコシステム全体の AI コールと計量を担います。消費の各単位はコールごとに記録・決済されます。',
      copyStrong: '実利用の計量基盤です。',
      copyAfter:
        ' ここで生じるプロトコル収益は $AIA バイバックの源泉の一つです。',
      flowAria: 'AI Token Hub 収益フロー',
      flow: [
        {
          title: '実 AI 利用',
          copy: '業界横断のコールをリクエスト単位で計量',
        },
        { title: 'プロトコル収益', copy: 'コールごとに $AIA / USDT で決済' },
        { title: 'Buyback $AIA', copy: 'プロトコル収益がバイバック原資' },
      ],
    },
    capabilities: {
      title: 'コア能力',
      items: [
        {
          title: '1つの API、多数のモデル',
          copy: 'Claude、GPT、Gemini、DeepSeek などを OpenAI 互換プロトコルで統一。文字列一つでモデル切替。',
        },
        {
          title: 'コール単位の計量',
          copy: 'リアルタイム計量、価格設定、コール単位決済。リクエスト本文は永続化せず、トークン数とレイテンシのみ。監査可能性とプライバシーの両立。',
        },
        {
          title: '$AIA 決済',
          copy: '$AIA または USDT で決済。$AIA チャージで割引 — プロトコル層のネイティブインセンティブ。',
        },
      ],
    },
    cta: {
      eyebrow: 'GET STARTED',
      title: '60 秒で統合',
      copy: 'ウォレットを接続し、base_url を一つ変えれば、すべての最先端モデルを呼び出せます。無料枠：月 100 万トークン。',
      button: 'プロダクトへ',
    },
  },
