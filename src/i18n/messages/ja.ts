...
export const ja: LocaleMessages = {
      ...
      cards: [
        {
          ...
          description:
            "アイデンティティ、継続性、コンセンサス — 信頼できるエージェントの基盤。",
        },
        {
          title: "自社開発モデル",
          description:
            "フィードバック学習の独自モデルにより、判断を再現・校正可能にします。",
        },
        {
          title: "A2A / MCP",
          description:
            "業界標準に対応し、クロスフレームワーク協働とツールアクセスを実現。",
        },
        {
          title: "MPC",
          description:
            "MPC によりトラストレス実行を可能にし、協働を安全にオンチェーンで決済。",
        },
      ],
    },
    product: {
  ...
  agents: {
    hero: {
      ...
      title: "AI Agents",
      description:
        "ワンクリックでデプロイ — 独自 API キーは不要。すべての推論は AI Token Smart Router 経由で決済され、$AIA または $USDT で支払います。最初のエージェントは Sentry。Hyperliquid 市場全体を 24/7 監視します。",
      kpis: [
        {
          label: "対象マーケット",
          value: 308,
  ...
  tokenHub: {
    hero: {
      title: "AI TOKEN SMART ROUTER",
      copyBefore:
        "すべてのフロンティアモデルに接続する単一エンドポイント。トークン課金、",
      copyStrongAia: "$AIA",
      copyMiddle: " または ",
      copyStrongUsdt: "$USDT",
      copyAfter: " で決済。",
    ...
    enterprise: {
      ...
      asideCopy:
        "レート制限、フェイルオーバー、コール単位のメータリングはすべてエンタープライズ要件から生まれました。個人も同等の機能を利用できます。",
      facts: [
    ...
    integration: {
      ...
      steps: [
        ...
        },
        {
          ...
          copyStrong: "15% 割引",
          copyAfter:
            "。残高と利用量はコンソールでリアルタイム確認、支出アラートも利用可能。",
        },
      ],
      codeLines: [
      ...
      steps: [
        {
          number: "01",
          title: "エージェント",
          copy: "Sentry を含む全エージェントの推論は Hub 経由。",
        },
        {
          number: "02",
          title: "ルーティング",
          copy: "38 モデル間で自動ルーティング/フェイルオーバー。レイテンシ・コスト・可用性で重み付け。",
        },
        {
          number: "03",
          title: "メータリング",
          copy: "トークン単位で計測。リクエスト/レスポンス本文は保存せず、件数とレイテンシのみ保持。",
        },
        {
          number: "04",
          title: "オープンアクセス",
          copy: "同じゲートウェイと SLA を第三者開発者に直接提供。",
        },
      ],
      diagram: {
        ...
        callers: [
          ...
          {
            title: "DeAgentAI エージェント",
            copy: "Sentry と全社内エージェント",
          },
  ...
  caseStudies: {
    hero: {
      ...
      feature: {
        title:
          "パートナーが DeAgentAI 上に構築すると、双方に新しい能力が生まれる",
  ...
  community: {
    ...
    traction: {
      ...
      stats: [
        ...
        },
        {
          value: "W3Labs",
          title:
            "DeAgentAI エコシステムファンドが孵化したオフラインコミュニティブランド",
          footnote: "",
        },
        {
          value: "複数回",
    ...
    blogs: {
      ...
      posts: [
        {
          date: "2026年8月",
          title: "インテリジェンス層からエコノミック層へ：ベア相場で価値フライホイールを回した方法",
