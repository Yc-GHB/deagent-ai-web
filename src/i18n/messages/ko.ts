...
export const ko: LocaleMessages = {
  ...
  tokenHub: {
    hero: {
      title: "AI TOKEN HUB",
      copyBefore: "모든 최신 모델을 위한 단일 엔드포인트. 토큰당 과금, ",
      copyStrongAia: "$AIA",
      copyMiddle: " 또는 ",
      copyStrongUsdt: "$USDT",
      copyAfter: "로 결제. ",
      copyStrongClients: "8개 엔터프라이즈 고객",
      copyEnd: "에게 제공 중이며, 개인 사용자에게 곧 공개됩니다.",
      kpis: {
        totalRequests: { label: "처리된 총 요청", value: "1,284,739,261", delta: "▲ 8.4%", deltaNote: "24시간 대비" },
        tokensProcessed: { label: "처리된 토큰", value: "847.26", unit: "B", delta: "▲ 12.1%", deltaNote: "24시간 대비" },
        mini: [
          { label: "온라인 모델", value: "38" },
          { label: "활성 API 키", value: "260+" },
          { label: "엔터프라이즈 고객", value: "8" },
          { label: "30일 가동률", value: "99.97%" },
        ],
      },
    },
    enterprise: {
      eyebrow: "엔터프라이즈 실적",
      title: "기업 우선, 개인은 다음.",
      copy: "개인 공개 전부터 이 게이트웨이는 엔터프라이즈 프로덕션 환경에서 운영되었습니다.",
      asideTitle: "동일한 게이트웨이. 동일한 SLA.",
      asideCopy: "레이트 리밋, 페일오버, 호출 단위 미터링은 모두 엔터프라이즈 요구사항에서 나왔습니다. 개인도 동일한 수준을 이용합니다.",
      facts: [
        { value: "8", label: "엔터프라이즈 고객 · 운영 중" },
        { value: "99.97%", label: "30일 가동률", highlight: true },
      ],
    },
    usage: {
      eyebrow: "사용 데이터",
      title: "투명한 사용량, 호출 단위 감사.",
      copy: "토큰당 과금, 사용량은 시간 단위로 집계됩니다. 토큰 수와 지연만 저장하며 요청/응답 본문은 저장하지 않습니다.",
      recentCalls: {
        title: "최근 호출",
        updated: "매시간 업데이트",
        rows: [
      ...
      chart: { title: "시간당 토큰 · 최근 24시간", peak: "피크 61.4M", axis: ["00:00", "08:00", "16:00", "현재"] },
    },
    models: {
      eyebrow: "모델 커버리지",
      title: "단일 API 키로 38개 모델.",
      copy: "주요 폐쇄형·오픈소스 모델을 OpenAI 호환 프로토콜로 통합. 모델 전환은 문자열 하나면 됩니다.",
      items: [
        { name: "Claude Opus 5", provider: "ANTHROPIC", price: "$15.00 / 1M out", volume: "Hub 트래픽 34%", volumePercent: 85, logo: "A", logoColor: "#d97757" },
        { name: "GPT-5.2", provider: "OPENAI", price: "$12.00 / 1M out", volume: "Hub 트래픽 26%", volumePercent: 65, logo: "O", logoColor: "#10a37f" },
        { name: "Gemini 3 Pro", provider: "GOOGLE", price: "$8.00 / 1M out", volume: "Hub 트래픽 17%", volumePercent: 42, logo: "G", logoColor: "#4285f4" },
        { name: "DeepSeek V4", provider: "DEEPSEEK", price: "$1.10 / 1M out", volume: "Hub 트래픽 12%", volumePercent: 30, logo: "D", logoColor: "#4d6bfe" },
        { name: "Grok 4", provider: "XAI", price: "$9.00 / 1M out", volume: "Hub 트래픽 6%", volumePercent: 15, logo: "X", logoColor: "#ffffff", logoTextColor: "#1a1a1a" },
        { name: "Qwen 3 Max", provider: "ALIBABA", price: "$2.40 / 1M out", volume: "Hub 트래픽 3%", volumePercent: 8, logo: "Q", logoColor: "#7c3aed" },
        { name: "Llama 4 405B", provider: "META · OSS", price: "$0.90 / 1M out", volume: "Hub 트래픽 1.5%", volumePercent: 4, logo: "M", logoColor: "#0668e1" },
      ],
      more: { name: "+31개 추가 모델", provider: "MISTRAL · COHERE · KIMI · ...", price: "-", volume: "Hub 트래픽 6.5%", volumePercent: 18, logo: "+", logoColor: "#6b6b73" },
    },
    integration: {
      eyebrow: "통합",
      title: "세 줄 코드로 마이그레이션.",
      codeFilename: "client.py",
      codeAria: "AI Token Hub 통합 예제",
      steps: [
        { title: "지갑 연결, 키 발급", copy: "지갑 서명으로 키를 발급합니다. 이메일 가입 불필요. 키는 주소에 바인딩되며 언제든 교체/폐기 가능." },
        { title: "base_url을 Hub로 설정", copy: "OpenAI SDK와 완전 호환. 기존 코드 변경 불필요. Python, TypeScript, Go, cURL 지원." },
        { title: "$AIA 또는 $USDT 충전", copyBefore: "$AIA 충전 시 ", copyStrong: "15% 할인", copyAfter: ". 잔액과 사용량은 콘솔에서 실시간 확인, 지출 알림 지원." },
      ],
      codeLines: [
    ...
    ecosystem: {
      eyebrow: "생태계 역할",
      title: "자사 에이전트를 위해 먼저 구축.",
      copy: "AI Token Hub는 새 제품이 아니라 자사 에이전트가 처음부터 사용한 추론 레이어입니다. 내부 8.4억 호출 후 외부 개발자에게 공개했습니다.",
      steps: [
        { number: "01", title: "에이전트", copy: "Sentry를 포함한 모든 에이전트 추론이 Hub를 경유합니다." },
        { number: "02", title: "라우팅", copy: "38개 모델 간 자동 라우팅/페일오버. 지연·비용·가용성 가중." },
        { number: "03", title: "미터링", copy: "토큰 단위 과금. 요청/응답 본문은 저장하지 않고 건수와 지연만 보관." },
        { number: "04", title: "오픈 액세스", copy: "동일 게이트웨이와 SLA를 서드파티 개발자에게 직접 제공." },
      ],
      diagram: {
        callersLabel: "호출자",
        gatewayLabel: "통합 게이트웨이",
        modelsLabel: "모델 레이어",
        hubTitle: "AI Token Hub",
        hubSubtitle: "OpenAI 호환 · 직접 구축",
        hubBullets: ["통합 인증 및 할당량", "지연·비용·가용성 기반 라우팅", "토큰 단위 과금, 콘텐츠 미저장"],
        hubStats: [{ value: "38", label: "온라인 모델" }, { value: "99.97%", label: "30일 가동률" }],
        callers: [
          { title: "엔터프라이즈 고객", copy: "8 · 프로덕션 운영" },
          { title: "DeAgentAI 에이전트", copy: "Sentry 및 모든 내부 에이전트" },
          { title: "개인 개발자", copy: "곧 공개", badge: "NEW" },
        ],
        models: ["Claude Opus 5", "GPT-5.2", "Gemini 3 Pro", "DeepSeek V4", "Grok 4 · Qwen 3 Max", "+31개 추가 모델"],
      },
    },
    waitlist: {
      title: "가장 먼저 알림",
      copy: "대기자 명단은 우선 접근권과 100만 시작 토큰 크레딧을 제공합니다.",
      emailAria: "이메일",
      emailPlaceholder: "이메일 입력",
      submit: "대기자 명단 참여",
      submitting: "제출 중…",
      success: "대기자 명단에 등록되었습니다",
      alreadyJoined: "이미 등록되어 있습니다",
      invalid: "유효한 이메일을 입력하세요",
      rateLimited: "시도 횟수가 너무 많습니다. 잠시 후 다시 시도하세요",
      unavailable: "대기자 명단을 일시적으로 사용할 수 없습니다",
