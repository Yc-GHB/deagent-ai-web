...
export const ko: LocaleMessages = {
        ...
        columns: [
          {
            title: '에이전트',
            items: [
              { title: 'AI Agents', description: '상시 가동 에이전트 배포', href: '/agents' },
              { title: 'CorrAI', description: '자율 전략 에이전트', href: 'https://corr.ai/en', external: true },
              { title: 'AlphaX', description: '자율 트레이딩 에이전트', href: '/alphax' },
            ],
          },
          {
            title: '인프라',
            items: [
              { title: 'AI Token Hub', description: '하나의 API, 모든 모델', href: '/token-hub' },
            ],
          },
        ],
      },
        ...
        columns: [
          {
            title: '함께 구축하기',
            items: [
              { title: '솔루션', description: '모델 역량을 API로', href: '/solutions' },
              { title: '사례 연구', description: 'AliceAI 및 파트너', href: '/case-studies' },
            ],
          },
        ],
      },
        ...
        columns: [
          {
            ...
            items: [
              ...
              { title: '토큰노믹스', href: 'https://deagentai.gitbook.io/deagentai', external: true },
            ],
          },
        ],
      },
        ...
        columns: [
          {
            title: '알아보기',
            items: [
              { title: '커뮤니티', description: '이벤트 & 밋업', href: '/community' },
              {
                title: '백서',
                description: '백서 읽기',
              ...
              { title: 'MiCA 백서', description: '컴플라이언스', href: 'https://deagent.ai/micar-whitepaper.pdf', external: true },
              { title: '리소스', description: '문서 및 더보기', href: 'https://medium.com/@deagent.ai', external: true },
            ],
          },
        ],
      },
  ...
  home: {
    ...
    trust: {
      ...
      cards: [
        ...
        {
          title: 'MPC',
          description: 'MPC는 무신뢰 실행을 가능하게 하며, 협업을 온체인에서 안전하게 정산합니다.',
        },
      ],
    },
    product: {
      ...
      capabilities: [
        {
          title: '원탭 배포',
          copy:
            '선택하고, 설정하고, 배포하세요. 호스팅과 지속성은 프로토콜이 처리합니다 — 인프라를 건드릴 필요 없습니다.',
        },
        {
          title: '보이지 않는 키',
          copy:
            '키는 신원에 의해 주입되고 프로토콜 아래에 숨겨지며, 계정별 서킷 브레이커가 연쇄 장애를 막습니다.',
        },
        {
          title: '모든 추론이 계량됨',
          copy:
            '모든 추론은 호출마다 기록되고, 소비량은 정산으로 바로 연결됩니다. 투명하고, 감사 가능하며, 침묵하지 않습니다.',
        },
      ],
    },
    ecosystem: {
      ...
      scenarios: [
        {
          ...
          copy:
            'CorrAI는 합의, 신원, 연속성 아래 De(cision)Agent 프레임워크 안에서 실행됩니다. DeAgentAI의 독자 모델을 호출해 전략 판단을 생성하고, 이를 자율적으로 계속 실행되는 전략 에이전트로 결정화합니다 — 온체인 판단에 처음으로 검증 가능한 전략적 연속성을 부여합니다.',
        },
        {
          title: 'AliceAI — 경기 예측 에이전트',
          copy:
            'AliceAI의 경기 예측은 DeAgentAI의 독자 모델 위에서 직접 실행됩니다. 모델이 경기 판단을 출력하면 AliceAI가 이를 자율적으로 결정하고 경제 레이어에서 정산하는 에이전트로 결정화합니다. CorrAI와 동일한 기반 스택을 공유합니다 — 하나의 지능이 서로 다른 시나리오로 흐릅니다.',
        },
      ],
      agentCards: {
  ...
  agents: {
    ...
    sentry: {
      ...
      filters: {
        ...
        outlierGuard: {
          title: '이상치 가드',
          description: '깔끔하게 정산되지 않을 수 있는 극단적 괴리를 건너뜁니다.',
        },
      },
      strategies: [
        { title: '펀딩 차익거래', description: '기준에서 멀리 떨어진 펀딩, 양방향', count: '47' },
        { title: '낮은 회전율', description: 'OI가 거래량보다 훨씬 높고 회전율 낮음', count: '52' },
        { title: '거래량 급증', description: '거래량과 가격이 함께 확대', count: '8' },
        { title: '프리미엄 괴리', description: '마크 가격이 오라클에서 이탈', count: '78' },
      ],
      matches: {
        title: '오늘의 매칭',
        ...
        columns: ['마켓', '펀딩 APR', '24시간 변동', '거래량', '미결제약정', '프리미엄'],
        categoryLabels: {
          Crypto: 'Crypto',
          Tradfi: 'Tradfi',
        },
    ...
    dailyPush: {
      ...
      title: '일일 푸시',
      copy:
        '매칭 결과는 매일 정해진 시간에 전달됩니다 — 플랫폼을 열 필요가 없습니다. 시장에 아무것도 없어도 보냅니다: 조작된 신호도, 침묵도 없습니다.',
      features: [
      ...
      bot: {
        name: 'Sentry BOT',
        time: '오늘 09:00',
        message: '오늘 Funding Arbitrage 기준에 47개 마켓이 매칭되었습니다. 강도 상위 3개:',
        assets: [
          { symbol: 'XMR', category: 'Crypto', note: '롱이 수취', change: '+20.93%' },
          { symbol: 'CASHCAT', category: 'Crypto', note: '숏이 수취', change: '+42.72%' },
          { symbol: 'KAITO', category: 'Crypto', note: '숏이 수취', change: '-295.73%' },
        ],
        memory: {
          title: '장기 메모리',
    ...
    memory: {
      ...
      remembered: {
        ...
        items: [
          ...
          { before: '마이너스 펀딩 선호, ', strong: '높은 레버리지 회피', after: '' },
          { before: '비슷한 셋업을 쫓다 물렸고, ', strong: '되돌림을 기다리라고 함', after: '' },
          { before: '명시적으로 제외: ', strong: '상장 7일 미만 마켓', after: '' },
      ...
      steps: [
        {
          title: '지갑 연결',
          text:
            '서명이 곧 로그인입니다. 이메일 없음, 비밀번호 없음. 신원은 내부 UID로 관리되므로, 나중에 여러 지갑이 크레딧과 메모리를 공유할 수 있습니다.',
        },
        {
          title: '에이전트 선택 및 기준 설정',
          text:
            '네 가지 프리셋 전략이 바로 작동하며, 임계값을 조정할 수 있습니다. 기준은 제약입니다: 에이전트는 당신이 그린 범위 안에서만 작동합니다.',
        },
        {
          title: '배포 클릭',
          text:
            '에이전트가 일일 일정으로 실행을 시작하고, 결과는 앱 내 또는 Telegram으로 푸시됩니다. 사용량과 잔액은 콘솔에서 호출별로 감사할 수 있습니다.',
        },
      ],
      codeSample: {
        commentRuntime:
        ...
        commentScreening: '# 스크리닝은 순수 연산, 토큰 비용 제로 (dim comment)',
      },
    },
    waitlist: {
      eyebrow: '얼리 액세스',
  ...
  alphax: {
    ...
    does: {
      title: 'AlphaX가 하는 일',
      intro: 'AlphaX는 독자 모델 지능과 자율 실행, 검증 가능한 결과를 결합합니다.',
      capabilities: [
        {
          title: '독자 모델 시그널',
          copy:
            '피드백 학습 기반의 독자 모델로 예측 시그널을 생성하고, 사용자 피드백을 통해 지속적으로 보정하여 역동적인 시장에서도 신뢰성과 적응력을 유지합니다.',
        },
        {
          title: '완전 자율 트레이딩',
          copy:
            '의사결정 지원을 넘어 — AlphaX는 시장을 모니터링하고, 전략을 실시간으로 조정하며, 암호화폐가 요구하는 속도와 정밀도로 독립적으로 실행합니다.',
        },
        {
          title: '온체인 감사 가능한 실적',
          copy:
            'De(cision)Agent 프레임워크 위의 에이전트로서, 결정은 신원과 연속성 원칙을 따르며, 결과는 온체인에서 감사하고 검증할 수 있습니다.',
        },
      ],
    },
    gallery: {
  ...
  tokenHub: {
    hero: {
      ...
      copyAfter: ' 요청 본문은 절대 저장되지 않으며, 토큰 수와 지연 시간만 보관됩니다.',
    ...
    role: {
      ...
      copyAfter: ' 여기서 발생하는 프로토콜 수익은 $AIA 바이백의 한 재원입니다.',
      ...
      items: [
        {
          title: '하나의 API, 여러 모델',
          copy:
            'Claude, GPT, Gemini, DeepSeek 등을 OpenAI 호환 프로토콜로 통합. 문자열 하나만 바꿔 모델을 전환하세요.',
        },
        {
          title: '호출별 계량',
          copy:
            '호출당 실시간 계량, 가격 책정, 정산. 요청 본문은 절대 저장되지 않으며 토큰 수와 지연 시간만 — 감사 가능성과 프라이버시의 균형.',
        },
        {
          title: '$AIA 정산',
          copy:
            '$AIA 또는 USDT로 정산. $AIA로 충전하면 할인이 적용되는 네이티브 프로토콜 수준 정산 인센티브.',
        },
      ],
    },
    cta: {
      ...
      title: '60초 만에 연동',
      copy:
        '지갑을 연결하고, base_url 하나만 바꾼 뒤 모든 프론티어 모델을 호출하세요. 무료 티어: 월 100만 토큰.',
      button: '제품 입장',
    },
  },
      ...
      guarantees: [
        {
          ...
          title: '자체 개발 모델',
          copy:
            '피드백 루프로 학습된 독자 모델이 구조화된 판단과 신뢰도를 출력합니다. 동일 입력에 재현 가능하며, 블랙박스 확률 출력이 아닙니다.',
        },
        {
          step: '02 · AGENT',
          title: '프레임워크 패키징',
          copy:
            'De(cision)Agent 프레임워크가 신원을 귀속하고, 상태를 기록하며, 합의 검사를 적용해 판단을 상태 있는 인스턴스로 래핑합니다.',
        },
        {
          step: '03 · SETTLEMENT',
          title: '경제 정산',
          copy:
            '판단 출력이 경제 레이어 정산으로 바로 연결되어, 온체인에서 계량되고 검증됩니다. 판단과 가치 사이에 간극이 없습니다.',
        },
      ],
    },
    capabilities: {
      ...
      items: [
        {
          title: '구조화된 판단',
          copy:
            '출력은 구조화된 판단 + 신뢰도 + 근거입니다. 합의 아래 피드백으로 지속적으로 보정되며, 동일 입력에 재현 가능하고 무작위 표류가 아닙니다.',
        },
        {
          title: '상태 있는 에이전트 인스턴스',
          copy:
            '각 호출은 고유 신원과 온체인 메모리를 귀속하여 판단에 상태와 연속성을 부여합니다. 범위 안에서 자율적이며, 완전히 추적 가능합니다.',
        },
        {
          title: '경제 정산 API',
          copy:
            '판단이 경제 레이어 정산에 직접 연결되어, 계량되고 검증 가능한 온체인 결과를 산출합니다. 판단과 가치 사이에 간극이 없습니다.',
        },
      ],
    },
    useCases: {
      title: '활용 사례',
      intro: '검증 가능한 판단과 정산 가능한 온체인 결과가 필요한 모든 시스템이 이 API를 재사용할 수 있습니다.',
      items: [
        {
          number: '01',
          title: '예측 & 시그널',
          copy:
            '경기, 시장, 이벤트 예측: 한 번의 호출로 구조화된 판단을 받아, 판단을 제품에서 분리합니다.',
        },
        {
          number: '02',
          title: '전략 & 실행 에이전트',
          copy:
            '판단에서 전략을 자율 실행하고, 온체인에서 감사 가능하며 경제 레이어에서 정산합니다.',
        },
        {
          number: '03',
          title: '온체인 거버넌스',
          copy:
            'DAO와 프로토콜을 위한 중립적이고 추적 가능한 판단 소스로, 제안 분석과 자동 실행을 지원합니다.',
        },
        {
          number: '04',
          title: '수직 의사결정 시스템',
          copy:
            '도메인 컨텍스트를 주입하고, 정산 가능한 판단 출력을 받아 기존 시스템에 빠르게 통합합니다.',
        },
      ],
    },
    integration: {
  ...
  caseStudies: {
    hero: {
      ...
      feature: {
        title: '파트너가 DeAgentAI 위에 구축하면, 양쪽 모두 새로운 역량을 얻습니다',
        copy:
          '월드컵 기간에 AliceAI는 일련의 API를 통해 DeAgentAI의 독자 모델 판단에 연결하고 경기 예측 에이전트를 출시했습니다. 자체 모델 제로, 경제 레이어에서 직접 정산.',
        meta: [
    ...
    path: {
      title: '기술 경로',
      intro: 'AliceAI가 호출하는 것은 원시 모델이 아니라 래핑된 판단-결정-정산 경로입니다.',
      steps: [
    ...
    results: {
      ...
      items: [
        { number: '2,000+', label: '경기 예측 시그널', sublabel: '월드컵 기간' },
        { number: 'XXk', label: '누적 모델 호출', sublabel: '확인 필요' },
        { number: '30k+', label: '일일 커뮤니티 화제', sublabel: 'AliceAI 경유' },
      ],
    },
    product: {
      title: '제품 안에서',
      brandBadge: 'ALICEAI',
      screens: [
        { badge: 'SCREEN 01', title: '예측 목록', subtitle: 'Placeholder · TBD' },
        { badge: 'SCREEN 02', title: '경기 상세', subtitle: 'Placeholder · TBD' },
        { badge: 'SCREEN 03', title: '판단 & 정산', subtitle: 'Placeholder · TBD' },
      ],
    },
    video: {
      title: '협업 영상',
  ...
  community: {
    hero: {
      ...
      copy:
        '탈중앙화 AI 에이전트 채택을 이끄는 개발자, 사용자, 빌더 커뮤니티 — 온라인과 현장에서.',
    ...
    snapshots: {
      title: '커뮤니티 스냅샷',
      filterAll: '모든 연도 · 모든 지역',
      sourcePhotosSuffix: ' 원본 사진',
      yearAria: '스냅샷 연도',
      cityAria: '스냅샷 도시',
      years: ['2024', '2025', '2026'],
      cities: ['Shenzhen AI Meetup', 'Hong Kong', "Xi'an"],
      photoAltTemplate: '{city} DeAgentAI 커뮤니티 이벤트',
    },
    conversation: {
      title: '글로벌 대화에 참여하세요',
      copy:
        'DeAgentAI 커뮤니티는 전 세계에 걸쳐 있습니다. 빌더, 개발자, 사용자와 실시간으로 대화하세요.',
      channels: [
    ...
    ambassador: {
      ...
      copy:
        'DeAgentAI 생태계의 촉매가 되세요. 탈중앙화 AI 채택을 이끄는 옹호자 커뮤니티에 합류하여 — 인식, 교육, 아웃리치에서 핵심 역할을 하세요.',
      cta: '곧 출시',
    },
    blogs: {
      title: 'DeAgentAI 최신 소식',
      posts: [
        { date: 'JUL 2026', title: '아티클 제목 플레이스홀더 · 실제 게시물로 교체' },
        { date: 'JUL 2026', title: '아티클 제목 플레이스홀더 · 실제 게시물로 교체' },
        { date: 'JUN 2026', title: '아티클 제목 플레이스홀더 · 실제 게시물로 교체' },
        { date: 'JUN 2026', title: '아티클 제목 플레이스홀더 · 실제 게시물로 교체' },
      ],
    },
  },
  ...
  buyback: {
    ...
    burnProgress: {
      ...
      note:
        '취득분의 일부가 3개월마다 온체인에서 소각됩니다 — 아래 소각 기록에서 트랜잭션 해시를 확인하세요. 분기별 소각 이벤트 후 업데이트됩니다.',
    },
    burnHistory: {
      title: '소각 기록',
    ...
    mechanism: {
      ...
      steps: [
        ...
        },
        {
          title: '영구 소각',
          copy:
            '재매입된 AIA는 공개된 커스터디에 보관되며 게시된 소각 일정에 따라 소각됩니다',
        },
      ],
    },
    priceTrend: {
    ...
    outcome: {
      ...
      copy:
        '더 많은 에이전트가 배포될수록 프로토콜 활동이 증가합니다. 수익이 프로그래밍 방식 바이백에 자금 조달하고, 예정된 소각이 가용 공급을 영구적으로 줄입니다.',
