...
export const zhCN: LocaleMessages = {
        ...
        columns: [
          {
            ...
            items: [
              ...
              { title: "W3Labs", description: "线下社区品牌", href: "/w3labs" },
              {
                title: "白皮书",
                description: "阅读白皮书",
                href: "https://deagentai.gitbook.io/deagentai",
  ...
  home: {
    ...
    product: {
      ...
      capabilities: [
        {
          title: "一键部署",
          copy: "选择、配置、部署。托管与持久化由协议处理——你无需触碰任何基础设施。",
        },
        {
          title: "密钥不可见",
          copy: "密钥由身份注入，隐于协议之下，并具备按账户熔断、互不级联的保护。",
        },
        {
          title: "每次推理均可计量",
          copy: "每一次推理按次记录，消耗直连结算。透明、可审计，绝不静默。",
        },
      ],
    },
    ecosystem: {
      ...
      scenarios: [
        {
          ...
          copy: "CorrAI 运行于 De(cision)Agent 框架，受共识、身份与连续性约束。它调用 DeAgentAI 专有模型生成策略判断，结晶为自主、持续运行的策略智能体——首次让链上判断具备可验证的策略连续性。",
        },
        {
          title: "AliceAI —— 赛事预测智能体",
          copy: "AliceAI 的赛事预测直接运行在 DeAgentAI 专有模型之上：模型输出赛事判断，AliceAI 将其结晶为可自主决策并在经济层结算的智能体。它与 CorrAI 共享同一底层栈——同一智能，流向不同场景。",
        },
      ],
      agentCards: {
  ...
  agents: {
    hero: {
      ...
      title: "AI Agents",
      description:
        "一键部署——无需自备 API Key。每次推理经 AI Token Smart Router 结算，可用 $AIA 或 $USDT 支付。首个智能体：Sentry，全天候监控整个 Hyperliquid 市场。",
      kpis: [
        {
          label: "覆盖市场",
          value: 308,
    ...
    sentry: {
      ...
      strategies: [
        {
          title: "资金费率套利",
          description: "资金费率远离基准，双向均可",
          count: "47",
        },
        {
          title: "低换手",
          description: "持仓远高于成交量，换手偏低",
          count: "52",
        },
    ...
    dailyPush: {
      badge: "即将推出",
      title: "每日推送",
      copy: "匹配结果每天在固定时间送达——无需打开平台。当市场无可匹配时，我们仍会发送：不捏造信号，也不沉默。",
      features: [
    ...
    deploy: {
      ...
      steps: [
        {
          title: "连接钱包",
          text: "签名即登录。无需邮箱，无需密码。身份由内部 UID 承载，后续多个钱包可共享额度与记忆。",
        },
        {
          title: "选择智能体并设定条件",
          text: "四种预设策略开箱即用，阈值可调。条件即约束：智能体只能在你划定的边界内工作。",
        },
        {
          title: "点击部署",
          text: "智能体按每日计划运行，结果推送到应用内或 Telegram。用量与余额可在控制台按次审计。",
        },
      ],
      codeSample: {
        filename: "agent.py",
        commentRuntime:
          "# 智能体运行时：Agno AgentOS，模型经 AI Token Smart Router 路由",
  ...
  alphax: {
    hero: {
      ...
      copyMid: "，受共识、身份与连续性约束。它由专有模型生成预测信号，并以 ",
      copyStrong2: "完全自主交易智能体",
      copyAfter: " 的形态行动——从决策辅助工具演进为独立运行的交易智能。",
      tagsAria: "AlphaX 产品属性",
      tags: ["反馈训练", "自主运行", "De(cision)Agent 框架", "链上可审计"],
    },
    does: {
      title: "AlphaX 能做什么",
      ...
      capabilities: [
        {
          title: "专有模型信号",
          copy: "基于反馈训练的专有模型生成预测信号，并经用户反馈持续校准，在动态市场中保持可靠与适应力。",
        },
        {
          title: "完全自主交易",
          copy: "不止于决策支持——AlphaX 监控市场、实时调整策略，并以加密市场所需的速度与精度独立执行。",
        },
        {
          title: "链上可审计业绩",
          copy: "作为 De(cision)Agent 框架上的智能体，其决策遵循身份与连续性原则，结果可在链上审计与验证。",
        },
      ],
    },
    gallery: {
  ...
  tokenHub: {
    hero: {
      title: "AI TOKEN SMART ROUTER",
      copyBefore: "一个端点接入全部前沿模型。按 token 计费，可用 ",
      copyStrongAia: "$AIA",
      copyMiddle: " 或 ",
      copyStrongUsdt: "$USDT",
      copyAfter: " 结算。已服务 ",
      copyStrongClients: "8 家企业客户",
      copyEnd: "，即将向个人开发者开放。",
      kpis: {
        totalRequests: {
          label: "累计处理请求",
        ...
        mini: [
          { label: "在线模型", value: "38" },
          { label: "活跃 API Key", value: "260+" },
          { label: "企业客户", value: "8" },
          { label: "30 日可用性", value: "99.97%" },
        ],
      },
    },
    enterprise: {
      eyebrow: "企业级履历",
      title: "先服务企业，再开放个人。",
      copy: "在向个人开放之前，该网关已在企业生产环境中稳定运行。",
      asideTitle: "同一网关，同一 SLA。",
      asideCopy:
        "限流、故障转移与按次计量均来自企业级需求。个人用户获得同等能力，无降级版本。",
      facts: [
        { value: "8", label: "企业客户 · 已上线" },
    ...
    usage: {
      eyebrow: "用量数据",
      title: "用量透明，每次调用可审计。",
      copy: "按 token 计费，用量按小时汇总。仅存储 token 计数与延迟，永不保存请求或响应内容。",
      recentCalls: {
        title: "最近调用",
        updated: "每小时更新",
        rows: [
    ...
    models: {
      eyebrow: "模型覆盖",
      title: "一个 API Key，38 个模型。",
      copy: "主流闭源与开源模型统一封装为 OpenAI 兼容协议，切换模型只需改一个字符串。",
      items: [
        {
          name: "Claude Opus 5",
          provider: "ANTHROPIC",
    ...
    integration: {
      ...
      codeAria: "AI Token Smart Router 集成示例",
      steps: [
        {
          title: "连接钱包，铸造 Key",
          copy: "使用钱包签名即可铸造 Key，无需邮箱注册。Key 绑定地址，可随时轮换或撤销。",
        },
        {
          title: "将 base_url 指向 Hub",
          copy: "完全兼容 OpenAI SDK，现有代码无需改动。支持 Python、TypeScript、Go 与 cURL。",
        },
        {
          title: "使用 $AIA 或 $USDT 充值",
          copyBefore: "使用 $AIA 充值可享 ",
          copyStrong: "15% 折扣",
          copyAfter: "。余额与用量在控制台实时可见，并支持消费告警。",
        },
      ],
      codeLines: [
    ...
    ecosystem: {
      eyebrow: "生态角色",
      title: "先为自有智能体而建。",
      copy: "AI Token Smart Router 并非独立新产品，而是自有智能体自始运行的推理层，在内部处理 8.4 亿次调用后向外部开发者开放。",
      steps: [
        {
          number: "01",
          title: "智能体",
          copy: "Sentry 与平台内全部智能体的推理均经 Hub 路由。",
        },
        {
          number: "02",
          title: "路由",
          copy: "在 38 个模型间自动路由与故障转移，按延迟、成本与可用性加权。",
        },
        {
          number: "03",
          title: "计量",
          copy: "按 token 计量。请求与响应体永不持久化，仅保留计数与延迟。",
        },
        {
          number: "04",
          title: "开放接入",
          copy: "同一网关与 SLA，直接向第三方开发者开放。",
        },
      ],
      diagram: {
        callersLabel: "调用方",
        ...
        hubStats: [
          { value: "38", label: "在线模型" },
          { value: "99.97%", label: "30 日可用性" },
        ],
        callers: [
          { title: "企业客户", copy: "8 · 生产环境运行中" },
          { title: "DeAgentAI 智能体", copy: "Sentry 及全部内部智能体" },
          { title: "个人开发者", copy: "即将开放", badge: "NEW" },
        ],
        models: [
          "Claude Opus 5",
          "GPT-5.2",
    ...
    waitlist: {
      title: "抢先知晓",
      copy: "候补名单成员可优先获得访问权限与 100 万起始 token 额度。",
      emailAria: "邮箱",
      emailPlaceholder: "输入邮箱",
      submit: "申请",
      submitting: "提交中…",
      success: "已成功加入候补名单",
      alreadyJoined: "您已在候补名单中",
      invalid: "请输入有效邮箱",
      rateLimited: "尝试次数过多，请稍后再试",
      unavailable: "候补名单暂时不可用",
      error: "提交失败，请稍后重试",
  ...
  solutions: {
    hero: {
      ...
      copySep2: "，并经 ",
      copyStrong3: "共识校验",
      copyAfter: "——你调用的不是原始推理，而是可追溯、可复现的判断单元。",
      ctaContact: "联系集成",
      ctaLearn: "了解更多",
    },
    how: {
      ...
      guarantees: [
        {
          step: "01 · 模型",
          title: "自研模型",
          copy: "经反馈循环训练的专有模型输出结构化判断与置信度。相同输入可复现，而非黑盒概率输出。",
        },
        {
          step: "02 · 智能体",
          title: "框架封装",
          copy: "De(cision)Agent 框架绑定身份、记录状态并施加共识校验，将判断封装为有状态实例。",
        },
        {
          step: "03 · 结算",
          title: "经济结算",
          copy: "判断输出直连经济层结算，可计量、链上可验证。判断与价值之间无断层。",
        },
      ],
    },
    capabilities: {
      ...
      items: [
        {
          title: "结构化判断",
          copy: "输出为结构化判断 + 置信度 + 依据。在共识下经反馈持续校准，相同输入可复现，而非随机漂移。",
        },
        {
          title: "有状态智能体实例",
          copy: "每次调用绑定唯一身份与链上记忆，使判断具备状态与连续性。在范围内自主，全程可追溯。",
        },
        {
          title: "经济结算 API",
          copy: "判断直接连接经济层结算，产出可计量、链上可验证的结果。判断与价值之间无断层。",
        },
      ],
    },
    useCases: {
      ...
      items: [
        {
          number: "01",
          title: "预测与信号",
          copy: "赛事、市场与事件预测：一次调用获得结构化判断，将判断与产品解耦。",
        },
        {
          number: "02",
          title: "策略与执行智能体",
          copy: "基于判断自主执行策略，链上可审计，并可在经济层结算。",
        },
        {
          number: "03",
          title: "链上治理",
          copy: "为 DAO 与协议提供中立、可追溯的判断源，支撑提案分析与自动化执行。",
        },
        {
          number: "04",
          title: "垂直决策系统",
          copy: "注入领域上下文，获得可结算判断输出，并快速接入现有系统。",
        },
      ],
    },
    integration: {
  ...
  caseStudies: {
    ...
    results: {
      title: "成果",
      intro: "以下数字以真实日志为准——发布前请核实；未确认项请留空，勿估算。",
      items: [
        { number: "2,000+", label: "赛事预测信号", sublabel: "世界杯期间" },
        { number: "100K+", label: "累计模型调用", sublabel: "" },
  ...
  community: {
    hero: {
      ...
      titleAccent: "社区",
      copy: "由开发者、用户与建设者组成的社区，线上线下共同推动去中心化 AI 智能体的采用。",
    ...
    snapshots: {
      title: "社区瞬间",
      photoAlt: "DeAgentAI 社区活动",
    },
    conversation: {
      title: "加入全球对话",
      copy: "DeAgentAI 社区遍布全球。与建设者、开发者和用户实时交流。",
      channels: [
    ...
    ambassador: {
      ...
      copy: "成为 DeAgentAI 生态的催化剂。加入倡导者社区，推动去中心化 AI 采用——在认知、教育与触达中发挥关键作用。",
      cta: "即将推出",
    },
    blogs: {
  ...
  buyback: {
    ...
    burnProgress: {
      ...
      note: "每 3 个月在链上销毁一部分——交易哈希见下方销毁历史，于每次季度销毁事件后更新。",
    },
    burnHistory: {
      title: "销毁历史",
    ...
    mechanism: {
      ...
      steps: [
        ...
        {
          title: "永久销毁",
          copy: "回购所得 AIA 存放于已披露托管，并按公布的销毁计划销毁",
        },
      ],
    },
    priceTrend: {
    ...
    outcome: {
      ...
      copy: "随着更多智能体部署，协议活动上升。收入资助程序化回购，而按计划销毁永久削减可用供给。",
  ...
  w3labs: {
    hero: {
      title: "W3Labs",
      subtitle: "DeAgentAI 生态基金孵化的线下社区品牌",
    },
    eventCards: {
      openClawShenzhen: {
        title: "OpenClaw Shenzhen",
        lines: ["2,000 名参会者", "1,000+ 社区转化", "50% 转化率"],
      },
      szhkWeb3: {
        title: "SZHK Web3",
        lines: ["50 名参会者", "40+ 社区转化", "80%+ 转化率"],
      },
      hichuangRaccoonAi: {
        title: "HiChuang × Raccoon AI",
        lines: ["80+ 报名", "50+ 名参会者", "50%+ 到场率"],
      },
      opcWorkBuddy: {
        title: "OPC × WorkBuddy",
        lines: ["86 人报名", "50+ 名参会者", "58%+ 到场率"],
      },
      hichuangEurasia: {
    ...
    purpose: {
      titleLine1: "为线下现场而生，",
      titleLine2: "而不只是为信息流。",
      copy: "W3Labs 为开发者、创始人和充满好奇的建设者提供面对面交流的空间，交换可落地的想法，并与 DeAgentAI 生态共同成长。",
      photoAlts: [
        "SZHK Web3 演讲嘉宾",
        "SZHK Web3 现场观众",
        "SZHK Web3 活动场地",
    ...
    archive: {
      eventsAria: "W3Labs 活动",
      wallAria: "W3Labs 社区照片墙",
      wallTitle: "W3Labs 社区档案",
      joinAria: "加入 W3Labs 社区",
      expandPhoto: "放大 {title} 照片 {index}",
      expandWallPhoto: "放大社区档案照片 {index}",
      photoAlt: "{title} — {index}",
      wallPhotoAlt: "W3Labs 社区档案 — {index}",
    ...
    cta: {
      title: "加入下一场对话。",
      copy: "连接 DeAgentAI 社区，关注即将到来的 W3Labs 线下活动。",
      button: "加入社区",
    },
  },
